...
struct army {
    ...
    static let ar40501PDF = "AR 40-501 Standards of Medical Fitness (14 Jun 2017)"
...
class ArmyViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let detailText:NSMutableAttributedString = NSMutableAttributedString(string: "\n" + (armyDocDetailArray[(indexPath as NSIndexPath).row] as! String), attributes: (NSDictionary(object: detailFont!, forKey: NSAttributedStringKey.font as NSCopying) as! [NSAttributedStringKey : Any]))
        ...
        let title = NSMutableAttributedString(string: armyDocArray[(indexPath as NSIndexPath).row] as! String, attributes: (NSDictionary(object: titleFont!, forKey: NSAttributedStringKey.font as NSCopying) as! [NSAttributedStringKey : Any]))
