...
struct aF {
    ...
    static let msdDetail = "Medical Standards Directory (02 Feb 2016)"
...
class AFViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if aF.selection == aF.otherTitle {
            performSegueWithIdentifier("aFOtherAFISegue", sender: nil)
        } else if aF.selection == aF.fsToolkitTitle {
            performSegueWithIdentifier("AFFSToolkitSegue", sender: nil)
        }else {
            performSegueWithIdentifier("aFWebviewSegue", sender: nil)
        }
